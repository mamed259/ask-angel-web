<template>
  <div 
  class="flex items-center justify-start gap-x-4 rounded-full  lg:my-0 max-w-[332px]" 
  :class="[
    type === 'author' ? 'bg-white pl-2 pr-8 w-full' : 'text-primary',
    type === 'author' ? 'py-2 mt-4 mb-8 lg:mt-0 lg:mb-0' : 'py-2'
    ]"
  >
